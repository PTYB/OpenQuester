...
object RuneMysteriesConstants {
    ...
    val CONVERSATION_AUBURY = arrayOf("I've been sent here with a package for you.")
    val CONVERSATION_DUKE_START = arrayOf("Have you any quests for me?", "Sure, no problem.", "Yes.")
    val CONVERSATION_SEDRIDOR = arrayOf("I'm looking for the head wizard.", "Okay, here you are.", "Go ahead.", "Yes, certainly.")
